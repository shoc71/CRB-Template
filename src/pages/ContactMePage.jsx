// the linkline that i'm using for collecting 
// the information is limiting to only these
// parameters. I am grateful it works.
// this will be expanded with backend features
